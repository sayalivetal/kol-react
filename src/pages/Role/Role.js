    ...
    <section className="main">
      <div className="container d-flex flex-wrap justify-content-center">
              ...
              <div className="card-body p-4">
                <div className="row justify-content-center">
                  <div className="col-12 text-center">
                    <h3 className="join-heading mt-3 mb-4">Join as a User or KOL</h3>
                  </div>
                      ...
                      <div className="col-lg-5 col-sm-12">
                        <div className="card joiner-card">
                          <div className="card-body">
                            ...
                            <div className="joiner-option">
                              <div className="join-option-label">Join as a User</div>
                              <input
                              type="radio"
                              value="3"
                              name="role"
                      ...
                      <div className="col-lg-5 col-sm-12">
                        <div className="card joiner-card">
                          ...
                          <div className="joiner-avatar-bg justify-content-center">
                            ...
                            <div className="joiner-option">
                              <div className="join-option-label">Join as a KOL</div>
                              <input
                                type="radio"
                                value="2"
                                name="role"
        ...
        <div className="row full-width align-self-end">
          <div className="col-12 text-center">
            <p className="cp-text">Copyright &copy; 2010-2022 KOL Company S.L. All rights reserved.</p>
          </div>
        </div>
      </div>
    </section>
