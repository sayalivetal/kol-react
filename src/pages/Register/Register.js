        ...
        <div className="container">
          <div className="card register-card">
            <div className="card-body register-card-body">
              <div className="row">
                <div className="col-lg-6 col-sm-12 register-div p-5">
                  <div className="d-flex  flex-wrap align-items-center p-5">
                    ...
                    <div className="bordered-text col-lg-8 col-md-12">
                        <p className="text-white mb-0">
                          To get the maximum attention on your product and services,
                          invest in KOL.
                        </p>
                    </div>
                ...
                <div className="col-lg-6  col-sm-12 p-5">
                  <div className="row align-items-center p-5">
                    ...
                    <div className="col-12 justify-content-center align-items-center position-relative my-4">
                        <hr className="col-12" /> <span className="orText">or </span>
                    </div>
